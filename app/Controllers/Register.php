    ...
    public function save()
    {
        ...
        $rules =
            [
                ...
                'middle_name' => 'required|max_length[50]|alpha',
                'last_name' => 'required|max_length[50]|alpha',
                'birth_date' => 'required|valid_date',
                'birth_place' => 'required|max_length[50]|alpha_space',
                'sex' => 'required|max_length[50]|alpha',
                'contact_number' => 'required|max_length[50]|is_natural',
                'province' => 'required|max_length[50]|alpha_space',
                'municipality' => 'required|max_length[50]|alpha_space',
                'barangay' => 'required|max_length[50]',
                'full_address' => 'required|max_length[50]',

                'elem_school' => 'required|max_length[50]|alpha_space',
                'second_school' => 'required|max_length[50]|alpha_space',
                'senior_school' => 'required|max_length[50]|alpha_space',
