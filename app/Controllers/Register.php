    ...
    public function save()
    {
        ...
        $rules =
            [
                ...
                'birth_place' => 'required|max_length[50]|alpha',
                'sex' => 'required|max_length[50]|alpha',
                'contact_number' => 'required|max_length[50]|is_natural',
                'province' => 'required|max_length[50]|alpha',
                'municipality' => 'required|max_length[50]|alpha',
                'barangay' => 'required|max_length[50]',
                'full_address' => 'required|max_length[50]',

                'elem_school' => 'required|max_length[50]|alpha',
                'second_school' => 'required|max_length[50]|alpha',
                'senior_school' => 'required|max_length[50]|alpha',
